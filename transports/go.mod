...
require (
	...
	github.com/maximhq/bifrost/plugins/governance v1.3.2
	github.com/maximhq/bifrost/plugins/logging v1.3.2
	github.com/maximhq/bifrost/plugins/maxim v1.4.2
	github.com/maximhq/bifrost/plugins/otel v1.0.2
	github.com/maximhq/bifrost/plugins/semanticcache v1.3.2
	github.com/maximhq/bifrost/plugins/telemetry v1.3.2
