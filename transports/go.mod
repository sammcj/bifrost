...
require (
	...
	github.com/maximhq/bifrost/plugins/otel v1.0.24
	github.com/maximhq/bifrost/plugins/semanticcache v1.3.24
...
require (
	...
	github.com/maximhq/bifrost/plugins/mocker v1.3.24 // indirect
