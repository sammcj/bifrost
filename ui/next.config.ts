...
const nextConfig: NextConfig = {
	...
	webpack: (config) => {
		...
		config.resolve.alias["@enterprise"] = haveEnterprise
			? path.join(__dirname, "app","workspace", "enterprise")
			: path.join(__dirname, "app", "workspace", "_fallbacks", "enterprise");
		config.resolve.alias["@schemas"] = haveEnterprise
			? path.join(__dirname, "app", "workspace", "enterprise", "lib", "schemas")
			: path.join(__dirname, "app", "workspace", "_fallbacks", "enterprise", "lib");		
