...
| ---------------- | ----------------- | ------------------- | ------------------------------------------------- |
| **OpenAI**       | `/openai/v1/*`    | Full compatibility  | [OpenAI Compatible](./openai-compatible)       |
| **Anthropic**    | `/anthropic/v1/*` | Full compatibility  | [Anthropic Compatible](./anthropic-compatible) |
| **Google GenAI** | `/genai/v1beta/*` | Full compatibility  | [GenAI Compatible](./genai-compatible)         |
...
- **[📖 OpenAI Integration Guide](./openai-compatible)**
...
- **[📖 Anthropic Integration Guide](./anthropic-compatible)**
...
- Content filtering
- **[📖 GenAI Integration Guide](./genai-compatible)**
...
- **[🚀 Quick Start](../../../quickstart/http-transport)** - 30-second setup

> **🏛️ Architecture:** For integration design patterns and performance details, see [Architecture Documentation](../../../architecture/README).
