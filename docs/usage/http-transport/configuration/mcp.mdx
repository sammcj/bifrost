...
> **💡 Quick Start:** See the [30-second setup](../../../quickstart/http-transport) for basic MCP configuration.
...
- **[🌐 Endpoints](../endpoints)** - HTTP API endpoints
- **[🛠️ Go Package MCP](../../go-package/mcp)** - MCP usage in Go package

> **🏛️ Architecture:** For MCP system design and performance details, see [Architecture Documentation](../../../architecture/README).
