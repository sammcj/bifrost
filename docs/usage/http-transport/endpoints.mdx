...
> **💡 Quick Start:** See the [30-second setup](../../quickstart/http-transport) for basic API usage.
...
> **📖 For more details:** See [Direct API Key Usage](../key-management#-direct-api-key-usage) for complete usage patterns and security considerations.
...
> **🏛️ Architecture:** For endpoint implementation details and performance, see [Architecture Documentation](../../architecture/README).
