...
> **💡 Quick Start:** See the [30-second setup](../../quickstart/go-package) for basic MCP configuration.
...
- **[🤖 Bifrost Client](./bifrost-client)** - Using MCP with client requests
- **[🔌 Plugins](./plugins)** - MCP monitoring plugins
- **[📋 Schemas](./schemas)** - MCP configuration structures
