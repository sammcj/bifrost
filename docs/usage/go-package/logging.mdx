...
> **💡 Quick Start:** See the [30-second setup](../../quickstart/go-package) for basic logging configuration.
...
- **[🤖 Bifrost Client](./bifrost-client)** - Client initialization with custom loggers
- **[🔌 Plugins](./plugins)** - Logging plugins and middleware
- **[📋 Schemas](./schemas)** - Logger interface and log level definitions
