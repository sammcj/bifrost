---
title: "📋 Schemas"
description: "Data structures, interfaces, and type definitions reference for Bifrost Go package. This guide focuses on practical usage patterns rather than comprehensive API documentation."
---
...
> **💡 Quick Start:** See the [30-second setup](../../quickstart/go-package) for basic schema usage examples.
...
- **[🤖 Bifrost Client](./bifrost-client)** - Using schemas with the client
- **[🏛️ Account Interface](./account)** - Account schema implementation
- **[🔌 Plugins](./plugins)** - Plugin schema implementation
- **[🛠️ MCP Integration](./mcp)** - MCP schema usage
- **[📊 Logging](./logging)** - Logger schema implementation
