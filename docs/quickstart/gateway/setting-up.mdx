...
<video width="100%" controls>
  <source src="../../media/run-npx.mp4" type="video/mp4" />
...
### Mode 1: Web UI Configuration (Recommended)
...
- **[Integrations](./integrations)** - Drop-in replacements for OpenAI, Anthropic, and GenAI SDKs
- **[MCP Tools](./mcp-tools)** - Enable AI models to use external tools (filesystem, web search, databases)
- **[Plugins](./plugins)** - Add semantic caching, governance, custom analytics

### Advanced Topics

- **[Monitoring](./monitoring)** - Prometheus metrics, request logging, and observability
- **[Core Features](../../features/)** - Governance, fallbacks, and advanced capabilities
