...
2. You may need to **restart Bifrost** for the changes to take effect (a warning will be displayed if a restart is required)
...
4. Restart Bifrost if prompted

After disabling, the dashboard will be accessible without authentication.