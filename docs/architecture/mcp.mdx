---
title: "🛠️ MCP System Architecture"
...
> **📖 MCP Configuration:** [MCP Setup Guide →](../usage/http-transport/configuration/mcp)
...
> **📖 Tool Filtering:** [MCP Tool Control →](../usage/http-transport/configuration/mcp#tool-filtering)
...
> **📖 MCP Development:** [Tool Development Guide →](../usage/mcp#developing-mcp-tools)
...
> **📖 MCP Security:** [Security Best Practices →](../usage/key-management#mcp-security)

---

## 🔗 Related Architecture Documentation

- **[🌐 System Overview](./system-overview)** - How MCP fits in the overall architecture
- **[🔄 Request Flow](./request-flow)** - MCP integration in request processing
- **[⚙️ Concurrency Model](./concurrency)** - MCP concurrency and worker integration
- **[🔌 Plugin System](./plugins)** - Integration between MCP and plugin systems
- **[📊 Benchmarks](../benchmarks)** - MCP performance impact and optimization
- **[💡 Design Decisions](./design-decisions)** - MCP architecture design rationale

---

**🎯 Next Step:** Understand the complete design rationale in **[Design Decisions](./design-decisions)**.
