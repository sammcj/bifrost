...
*   **Interfaces**: The `LogStore` interface defines the contract for all logging operations.
*   **Abstraction**: The `RDBLogStore` provides a common implementation for relational databases, handling most of the heavy lifting using an ORM.
