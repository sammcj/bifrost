...
<Update label="Core" description="v1.3.20">
...
<Update label="Framework" description="v1.3.20">
...
<Update label="governance" description="v1.3.20">

- chore: version update core to 1.2.20 and framework to 1.1.24

</Update>
<Update label="jsonparser" description="v1.3.20">

- chore: version update core to 1.2.20 and framework to 1.1.24

</Update>
<Update label="logging" description="v1.3.20">

- chore: version update core to 1.2.20 and framework to 1.1.24
- feat: add selected key and virtual key to logs

</Update>
<Update label="maxim" description="v1.3.20">

- chore: version update core to 1.2.20 and framework to 1.1.24

</Update>
<Update label="mocker" description="v1.3.20">

- chore: version update core to 1.2.20 and framework to 1.1.24

</Update>
<Update label="otel" description="v1.3.20">

- chore: version update core to 1.2.20 and framework to 1.1.24

</Update>
<Update label="semanticcache" description="v1.3.20">

- chore: version update core to 1.2.20 and framework to 1.1.24

</Update>
<Update label="telemetry" description="v1.3.20">
