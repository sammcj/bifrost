...
<Note>
This feature is only available on `v1.4.0-prerelease1` and above. Please check the [changelogs](../../changelogs) for more details.
</Note>
...
Learn more about Virtual Key tool filtering in [MCP Tool Filtering](../governance/mcp-tools).
...
<CardGroup cols={2}>
  ...
  <Card title="Virtual Key MCP Tools" icon="key" href="../governance/mcp-tools">
