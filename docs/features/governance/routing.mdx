...
<Note>This routing wont trigger when allowed models array is empty (all models allowed). You need to explicitly mention the models in allowed models array to trigger this routing.</Note>
