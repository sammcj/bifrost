...
<img src="/images/governance/provider-config-ui.png" alt="Provider-level governance configuration in Bifrost Web UI showing budget and rate limit settings per provider" placeholder />
...
<img src="/images/governance/provider-usage-dashboard.png" alt="Provider usage dashboard showing budget consumption and rate limit utilization across different AI providers" placeholder />
