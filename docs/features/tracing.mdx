...
![Live Log Stream Interface](../media/live-log-stream.png)

## How It Works

Bifrost traces comprehensive information for every request:

![Complete Request Tracing Overview](../media/request-tracing-overview.png)
...
![Multimodal Request Tracing](../media/multimodal-tracing.png)
...
![Tracing Configuration Interface](../media/tracing-config-ui.png)

1. Navigate to **http://localhost:8080**
2. Go to **"Settings"** → **"Tracing"**
3. Toggle **"Enable Request Tracing"** 
4. Configure **"Log Store"** settings:
   - **Type**: Currently SQLite (Postgres, MySQL, ClickHouse planned)
   - **Path**: Database file location
5. Save configuration

The UI shows real-time connection status and storage usage.
...
![Advanced Log Filtering Interface](../media/log-filtering-ui.png)
...
![Log Store Configuration Interface](../media/log-store-config.png)
